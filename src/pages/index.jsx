  ...
  return (
    <>
      ...
      <div className='max-w-full mx-auto relative bg-white overflow-hidden p-0 m-0'>
          ...
          <main className='mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28'>
            <div className='sm:text-center lg:text-left'>
              <h1 className='text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl'>
                <span className='block xl:inline'>Hey,</span>
        ...
        <div className='lg:absolute lg:inset-y-0 lg:right-0  lg:w-1/2 lg:top-0'>
          <Atropos
            style={{
              // width: '500px',
              height: '100%',
          ...
          >
            {/* ... */}
            <img src={images[0].original} data-atropos-offset='0' />
          </Atropos>
        </div>
